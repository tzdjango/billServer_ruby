...
class PeriodsControllerTest < ActionController::TestCase
  ...
  test "should create period" do
    assert_difference('Period.count') do
      post :create, period: { from: @period.from, statement_id: @period.statement_id, to: @period.to }
    end
  ...
  test "should update period" do
    patch :update, id: @period, period: { from: @period.from, statement_id: @period.statement_id, to: @period.to }
    assert_redirected_to period_path(assigns(:period))
  end
