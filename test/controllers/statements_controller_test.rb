...
class StatementsControllerTest < ActionController::TestCase
  ...
  test "should create statement" do
    assert_difference('Statement.count') do
      post :create, statement: { bill_id: @statement.bill_id, due: @statement.due, generated: @statement.generated }
    end
  ...
  test "should update statement" do
    patch :update, id: @statement, statement: { bill_id: @statement.bill_id, due: @statement.due, generated: @statement.generated }
    assert_redirected_to statement_path(assigns(:statement))
  end
