...
class CallsControllerTest < ActionController::TestCase
  ...
  test "should create call" do
    assert_difference('Call.count') do
      post :create, call: { callCharges_id: @call.callCharges_id, called: @call.called, cost: @call.cost, duration: @call.duration }
    end
  ...
  test "should update call" do
    patch :update, id: @call, call: { callCharges_id: @call.callCharges_id, called: @call.called, cost: @call.cost, duration: @call.duration }
    assert_redirected_to call_path(assigns(:call))
  end
